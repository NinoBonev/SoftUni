...
public class BabyController {
    ...
    public String editProcess(BabyBindingModel babyBindingModel, @PathVariable int id) {
        Baby babyFromDB = this.babyRepository.findOne(id);

        babyFromDB.setName(babyBindingModel.getName());
        babyFromDB.setGender(babyBindingModel.getGender());
        babyFromDB.setBirthday(babyBindingModel.getBirthday());

        this.babyRepository.saveAndFlush(babyFromDB);
    ...
    public String deleteProcess(@PathVariable int id) {
        ...
        this.babyRepository.delete(baby);
